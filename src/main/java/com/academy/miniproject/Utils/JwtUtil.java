package com.academy.miniproject.Utils;
...
public class JwtUtil {
    ...
    private String SECRET_KEY = "k!r@n";
    ...
    private String createToken(Map<String, Object> claims, String subject) {
    	System.out.println("my secret key -->"+SECRET_KEY);
    	/* signwith method expeect string type secert key but secret key with encoded form*/
    	String encodedString = Base64.getEncoder().encodeToString(SECRET_KEY.getBytes());
